 ...
 * 
 * @note Pokud nebude fungovat spravne, zmenit na 10ms 
 *       (doba, kdy by mel LCD radic mit prikaz zpracovan a busy flag volny).
 *
 */
INLINE_STM32 void LCD_busy(void) {
  delay_us(4);  // 400us;
}

/**
 * @brief  Zapis nibble informace
 * 
 * @note Vyuziti 4bit komunikace, prikazy jsou vsak 8-bitove.
 *
 ...
 * 
 * Funkce neresi pocet znaku na radek, ani pocet radku,
 * nutno resit v samotnem programu nebo si napsat vl. funkci.
 *
 * @param[in] text Retezec/pole znaku, jez se maji vypsat na LCD.
 *
 */
