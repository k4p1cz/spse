/**
  ...
  *
  *   Externi LED:
  *       Dodatecne LED pripojene jak ke skolnimu, tak domacimu pripravku, 
  *       viz specifikace vyse.
  *
  *
  ******************************************************************************
  * @history
  ...
  *
  *   v1.0  [10-April-2022]
  *         - Pro pripravek G071 zmena portu a pinu pro vestavene LED a zmena
  *             pinu pro externi LED (odseparovani od F401, F411 a L152 v ramci
  *             pouzitych maker), vyuziti volnych pinu (ty jez jsou urceny jen
  *             jako I/O)
 ...
 *         Aktivace portu pro vestavenou(e) LED a uzivatelske tlacitko, vcetne
 *         nastaveni smeru pinu na nich.
 *
